  ...
  <Container maxW="container.md">
    <VStack spacing={5}>
      ...
      <FormControl id="shippingDetails" isRequired>
        ...
        <Input name="shippingDetails" value={formData.shippingDetails} onChange={handleInputChange} placeholder="Enter shipping details" color="white" />
      </FormControl>
      ...
      <FormControl id="materialSpecs" isRequired>
        ...
        <Input name="materialSpecs" value={formData.materialSpecs} onChange={handleInputChange} placeholder="Specify the material specs" color="white" />
      </FormControl>
      ...
      <FormControl id="sampleLocations" isRequired>
        ...
        <Input name="sampleLocations" value={formData.sampleLocations} onChange={handleInputChange} placeholder="Upload a picture showing sample locations" type="file" accept="image/*" color="white" />
      </FormControl>
      <FormControl id="logoUpload" isRequired>
        <FormLabel color="white">Upload Logo/Design</FormLabel>
        <Input name="logoUpload" type="file" accept=".vector, .pdf, .png, .bmp, .jpg, .ai, .plt" onChange={handleInputChange} color="white" />
      </FormControl>
